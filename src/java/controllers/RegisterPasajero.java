 ...
 * @author juana
 */
@WebServlet(name = "RegisterPasajero", urlPatterns = {"/RegisterPasajero"})
public class RegisterPasajero extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher view = request.getRequestDispatcher("RegisterPasajero.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Pasajero p = new Pasajero(email, password, name, cellphone);
            RidersList.add(p);
