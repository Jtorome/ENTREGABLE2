...
public class Pasajero extends Persona {
    ...
    public List<Servicio> getServiceListPa() {
        return this.ServiceListPa;
    }

    public List<Calificacion> getScoreListPa() {
        return this.ScoreListPa;
    }

    public List<Servicio> getCurrentTrip() {
        return this.CurrentTrip;
    }

    public List<Servicio> getUnqualifiedService() {
        return this.UnqualifiedService;
    }

    public static Pasajero BuscadorPasajero(String email, List<Pasajero> RidersList) {
        for (Pasajero pas : RidersList) {
            if (pas.getEmail().equals(email)) {
                return pas;
            }
        }
        return null;
