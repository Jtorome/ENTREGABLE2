<%-- 
    Document   : ComentarPas
    Created on : 4/04/2019, 11:50:17 PM
    Author     : juana
--%>
...
<body class="bg-dark">
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
                <form action="ComentarPas" method="POST">
                ...
                <div class="text-center">
                    <a class="d-block small mt-3" href="/Entregable2/IndexPasajero">Atras.</a>
                </div>
            </div>
        </div>
    </div>
