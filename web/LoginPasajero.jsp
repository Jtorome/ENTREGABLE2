<%-- 
    Document   : Login
    Created on : 23/03/2019, 09:59:55 PM
    Author     : juana
--%>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            ...
            <div class="card-body">
                <form action="LoginPasajero" method="POST">
                    ...
                    <input name="btnAceptar" type="submit" class="btn btn-primary btn-block" value="Iniciar sesion como pasajero"/>
                </form>
