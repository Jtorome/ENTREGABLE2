<%-- 
    Document   : RegisterConductor
    Created on : 24/03/2019, 12:35:09 PM
    Author     : juana
--%>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            <div class="card-header">Registrar como conductor.</div>
            <div class="card-body">
                <form method="POST" action="RegisterConductor">
                    ...
                    <input name="btnRegistrarme" type="submit" class="btn btn-primary btn-block" value="Registrarme como conductor"/>
                </form>
                <div class="text-center">
                    <a class="d-block small mt-3" href="Login.jsp">Iniciar sesion</a>
                    <a class="d-block small mt-3" href="Start.jsp">Atras.</a>
                </div>
            </div>
        </div>
    </div>
